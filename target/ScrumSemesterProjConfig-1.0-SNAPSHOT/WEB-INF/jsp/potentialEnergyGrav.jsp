...
<html>
    ...
    <body>
        ...
        <h1 class="text-center">Potential Energy (W/ Gravity)</h1>


            <form:form class="form-horizontal" method="POST" action="${cp}/potentialEnergyGrav" modelAttribute="potentialEnergyGrav">
