...
<html>
    ...
    <body>
        ...
        <h1 class="text-center">Straight Earth Fall Distance</h1>


            <form:form class="form-horizontal" method="POST" action="${cp}/straightEarthFallDistance" modelAttribute="straightEarthFallDistance">
